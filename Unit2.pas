...
begin
DataModule4.ADOTable1.Edit;
TBlobField(DataModule4.ADOTable1.FieldByName('Обложка')).LoadFromFile(OpenPictureDialog1.FileName);
...
begin
    if Length(Edit2.Text) > 0 then
       begin
            ...
            DataModule4.ADOTable1.Filter:='Жанр LIKE '+ #39 + Edit2.Text + '%' + #39;
...
if Length(Edit2.Text) > 0 then
       begin
            DataModule4.ADOTable1.Filtered:=false;
            DataModule4.ADOTable1.Filter:='Год LIKE '+ #39 + Edit2.Text + '%' + #39;
            DataModule4.ADOTable1.Filtered:=true;
       end
    else DataModule4.ADOTable1.Filtered:=false;
end;
...
begin
    if Length(Edit2.Text) > 0 then
       begin
            DataModule4.ADOTable1.Filtered:=false;
            DataModule4.ADOTable1.Filter:='Название LIKE '+ #39 + Edit2.Text + '%' + #39;
            DataModule4.ADOTable1.Filtered:=true;
       end
    else DataModule4.ADOTable1.Filtered:=false;
end;
...
begin
Datamodule4.ADOTable1.IndexFieldNames:='Название';
end;

procedure TForm2.N11Click(Sender: TObject);
begin
Datamodule4.ADOTable1.IndexFieldNames:='Жанр';
end;

procedure TForm2.N9Click(Sender: TObject);
begin
Datamodule4.ADOTable1.IndexFieldNames:='Год';
end;
